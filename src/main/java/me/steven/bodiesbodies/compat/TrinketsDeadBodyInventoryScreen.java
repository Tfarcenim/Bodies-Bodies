...
public class TrinketsDeadBodyInventoryScreen  extends AbstractContainerScreen<TrinketsDeadBodyInventoryScreenHandler> {
    private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation("bodiesbodies", "textures/gui/trinkets_dead_body_inventory.png");
    private final DeathData deathData;

    public TrinketsDeadBodyInventoryScreen(TrinketsDeadBodyInventoryScreenHandler handler, Inventory inventory, Component title, DeathData deathData) {
